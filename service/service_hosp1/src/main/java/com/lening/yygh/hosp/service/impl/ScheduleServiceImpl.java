...
import com.lening.yygh.model.hosp.BookingRule;
...
import com.lening.yygh.vo.hosp.BookingScheduleRuleVo;
...
public class ScheduleServiceImpl extends ServiceImpl<ScheduleMapper, Schedule> implements ScheduleService {
    ...
    public Map<String, Object> getBookingScheduleRule(int page, int limit, String hoscode, String depcode) {
        ...
        if (!CollectionUtils.isEmpty(mappedResults)){
            scheduleVoMap = mappedResults.stream().collect(
        ...
        for (int i=0,len = dateList.size();i<len;i++){
            ...
            //最后一页最后一条记录为即将预约  状态0：正常  1：即将放号   -1：当天已经停止放号
        ...
        //科室
        Department department =departmentService.getDepartmentList(hoscode, depcode);
        //大科室名称
    ...
    private IPage getListDate(int page, int limit, BookingRule bookingRule) {
        ...
        //如果当天放号时间已经过去了，预约周期要从后一天开始计算，周期+1
